...
from base_controllers.utils.microfono_kin_dyn_utils import numericalInverseKinematics_1 as ik1
...
while np.count_nonzero(p_0 - p_des):
    ...
    q_f, log_err, log_grad = ik1(p_0, q, line_search=False, wrap=False)
